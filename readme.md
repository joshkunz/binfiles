...
* kick-wifi - Try to re-initialize the wifi-interface and then connect to the
  preferred service using connman.
...
* strip\_audio - BASH script for removing audio from video track.
